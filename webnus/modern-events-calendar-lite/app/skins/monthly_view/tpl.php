...
if($this->next_previous_button)
{
    ...
    {
        $navigator_html .= '<div class="mec-previous-month abc mec-load-month mec-previous-month" data-mec-year="'.date('Y', $_1month_before).'" data-mec-month="'.date('m', $_1month_before).'"><a href="#" class="mec-load-month-link"><i class="mec-sl-angle-left"></i> '.$this->main->date_i18n('F', $_1month_before).'</a></div>';
    }
        ...
        <div class="mec-calendar-side mec-clear">
            ...
            <div class="mec-skin-monthly-view-month-navigator-container">
                ...
                <!-- <div class="cal-events" > -->
                    <?php 
                        // echo 'Your dates have events from: SITE A, SITE B, SITE X';
                        // print_r($this->events);
                        ...
                        //     $sites[] = get_field('site', $val )->post_title;
                        // }
                        //echo 'Your dates have events from: '.implode(',', array_unique($sites));
                    ?>
                <!-- </div> -->
            </div>
            <?php else: ?>
